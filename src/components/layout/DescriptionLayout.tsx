export const DescriptionLayout = () => <section className="bg-black py-10 px-4 text-white">
    ...
    <p>
        ...
        on anime and with some Lovecraftian-like creatures.
    </p>
    <p>
    ...
    <p>
        ...
        its writers to name the most recent version as <b>Tormenta 20</b>.
    </p>
    </article>

    <article className="flex flex-col gap-4">
    <h1 className="text-4xl mt-8 font-bold">How it works?</h1>
    <p>
    ...
    <p>
        ...
        rolling a 4d6 taking the 3 highest and looking into a table to
        define the attribute, the other one is a <b>points system</b>,
        which this calculator is made for.
    </p>
    </article>
</section>