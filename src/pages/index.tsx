      ...
      <main >
        ...
        <section className="bg-black py-10 px-4 text-white">
          <article className="flex flex-col gap-4">
            <h1 className="text-4xl mt-12">What is this application?</h1>
            <p>
          ...
          <article className="flex flex-col gap-4">
            <h1 className="text-4xl mt-8">How it works?</h1>
            <p>
              On Tormenta20 &quot;Edição Jogo do Ano&quot; the character&apos;s
              attributes are the same from D&D3.5: Strength, Dexterity, Constitution,
              Intelligence, Wisdom and Charisma, but theres no modifier mechanic, because,
              on T20 the attribute value works as the classical attribute modifier.
            </p>
            <p>
